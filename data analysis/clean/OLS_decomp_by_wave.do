...
forval i=1/15 {
	...
	display `i' + 2
	oaxaca log_real_wage experience experience_sq edu_uni edu_diploma children_1 children_2 children_3 children_4_plus health_poor birth_eng birth_neng married_yes married_sep urban_no state_VIC state_WA state_QLD state_SA state_NT state_TAS state_ACT shiftwork_yes parttime long_hours casual if sex_male == 1 & wave >= `i' & wave <= (`i' + 4), by(sector_private) weight(1) nodetail // vce(bootstrap)
}
...
forval i=1/15 {
	display "5 year pool centred on:"
	display `i' + 2
	oaxaca log_real_wage experience experience_sq edu_uni edu_diploma children_1 children_2 children_3 children_4_plus health_poor birth_eng birth_neng married_yes married_sep urban_no state_VIC state_WA state_QLD state_SA state_NT state_TAS state_ACT shiftwork_yes parttime long_hours casual if sex_male == 0 & wave >= `i' & wave <= (`i' + 4), by(sector_private) weight(1) nodetail // vce(bootstrap)
}
...
forval i=1/15 {
	display "5 year pool centred on:"
	display `i' + 2
	oaxaca log_real_wage experience experience_sq edu_uni edu_diploma children_1 children_2 children_3 children_4_plus health_poor birth_eng birth_neng married_yes married_sep urban_no state_VIC state_WA state_QLD state_SA state_NT state_TAS state_ACT shiftwork_yes parttime long_hours casual occ_machinery occ_tech_trade occ_clerical_admin  occ_prof occ_community_personal_service occ_sales occ_labourer if sex_male == 0 & wave >= `i' & wave <= (`i' + 4), by(sector_private) weight(1) nodetail // vce(bootstrap)
}
...
forval i=7/15 {
	display "5 year pool centred on:"
	display `i' + 2
	oaxaca log_real_wage experience experience_sq edu_uni edu_diploma children_1 children_2 children_3 children_4_plus health_poor birth_eng birth_neng married_yes married_sep urban_no state_VIC state_WA state_QLD state_SA state_NT state_TAS state_ACT shiftwork_yes parttime long_hours casual if sex_male == 1 & wave >= `i' & wave <= (`i' + 4) & top_up == 0, by(sector_private) weight(1) nodetail // vce(bootstrap)
}
