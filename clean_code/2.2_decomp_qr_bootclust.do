...
bootstrap, cluster(xwaveid_factor) reps(10): cdeco log_real_wage experience experience_sq edu_uni edu_diploma children_1 children_2 children_3 children_4_plus health_poor birth_eng birth_neng married_yes married_sep urban_no state_VIC state_WA state_QLD state_SA state_NT state_TAS state_ACT shiftwork_yes parttime long_hours casual tenure i.wave if sex_male == 1, group(sector_private) quantile(0.1, 0.25, 0.5, 0.75, 0.9) noboot
// Men with occupation
...
// Men short
cdeco log_real_wage experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 1 [pw=hhwtrp], group(sector_private) quantile(0.1, 0.25, 0.5, 0.75, 0.9) reps(50)
...
// Women short
cdeco log_real_wage experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 0 [pw=hhwtrp], group(sector_private) quantile(0.1, 0.25, 0.5, 0.75, 0.9) reps(50)
eststo qrd_women_short

//esttab
esttab qrd_men_noc qrd_men_oc qrd_men_short qrd_women_noc qrd_women_oc qrd_women_short using "/home/sean/Code/honours/hons-project/output_tables/qr_decomp.csv", cells(b se) replace

esttab qrd_men_noc qrd_men_oc qrd_men_short qrd_women_noc qrd_women_oc qrd_women_short using "/home/sean/Code/honours/hons-project/output_tables/detail/qr_decomp.csv", cells(b se) replace
