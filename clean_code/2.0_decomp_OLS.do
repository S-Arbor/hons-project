...
// Men short
oaxaca log_real_wage experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 1 [pw=hhwtrp], by(sector_private) weight(1) vce(cluster xwaveid) nodetail
...
// Women short
oaxaca log_real_wage experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 0 [pw=hhwtrp], by(sector_private) weight(1) vce(cluster xwaveid) nodetail
eststo oax_women_short

//esttab
esttab oax_men_noc oax_men_oc oax_men_short oax_women_noc oax_women_oc oax_women_short using "/home/sean/Code/honours/hons-project/output_tables/ols_decomp.csv", cells(b se) replace

esttab oax_men_noc oax_men_oc oax_men_short oax_women_noc oax_women_oc oax_women_short using "/home/sean/Code/honours/hons-project/output_tables/detail/ols_decomp.csv", cells(b se) replace
