...
// Men short
regress log_real_wage sector_public experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 1 [pw=hhwtrp], vce(cluster xwaveid)
...
esttab ols_men_noc ols_men_oc ols_men_simple ols_women_noc ols_women_oc ols_women_simple using "/home/sean/Code/honours/hons-project/output_tables/cross_sect_no_decomp.csv", keep(sector_public) cells(b se) replace

esttab ols_men_noc ols_men_oc ols_men_simple ols_women_noc ols_women_oc ols_women_simple using "/home/sean/Code/honours/hons-project/output_tables/detail/basic_ols.csv", cells(b se) replace
...
// Men short
qrprocess log_real_wage sector_public experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 1 [pw=hhwtrp], quantile(0.1, 0.25, 0.5, 0.75, 0.9) vce(bootstrap, cluster(xwaveid_factor))
...
// Women short
qrprocess log_real_wage sector_public experience experience_sq edu_uni edu_diploma children_0 health_poor birth_eng birth_neng married_yes married_sep urban_no parttime casual tenure wave wave_sq if sex_male == 0 [pw=hhwtrp], quantile(0.1, 0.25, 0.5, 0.75, 0.9) vce(bootstrap, cluster(xwaveid_factor))
eststo qr_women_simple

// esttab
esttab qr_men_noc qr_men_oc qr_men_simple qr_women_noc qr_women_oc qr_women_simple using "/home/sean/Code/honours/hons-project/output_tables/cross_sect_no_decomp.csv", keep(sector_public) cells(b se) append

esttab qr_men_noc qr_men_oc qr_men_simple qr_women_noc qr_women_oc qr_women_simple using "/home/sean/Code/honours/hons-project/output_tables/detail/basic_qr.csv", cells(b se) replace

// esttab correction
esttab ols_men_simple ols_women_simple using "/home/sean/Code/honours/hons-project/output_tables/cross_sect_no_decomp_simple.csv", keep(sector_public) cells(b se) replace
esttab qr_men_simple qr_women_simple using "/home/sean/Code/honours/hons-project/output_tables/cross_sect_no_decomp_simple.csv", keep(sector_public) cells(b se) append
